...
POSTGRESQL_PASSWORD = os.environ.get("WB_PACKER_DB_PASSWORD", "DWV8ns27")
...
def apply_db_settings(settings):
    ...
    POSTGRESQL_PASSWORD = settings.get('postgresql_password', 'DWV8ns27')
